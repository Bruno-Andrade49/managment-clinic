  ...
  <div class="app-layout" :class="{ 'sidebar-open': sidebarOpen }">
    ...
    <aside class="sidebar">
      ...
      <nav class="sidebar-nav">
        ...
        <NuxtLink to="/" class="sidebar-nav-item" :class="{ active: route.path === '/' }" @click="sidebarOpen = false">
        ...
        <NuxtLink to="/patients" class="sidebar-nav-item" :class="{ active: route.path.startsWith('/patients') && !route.path.includes('/chat') }" @click="sidebarOpen = false">
          <svg class="sidebar-nav-icon" fill="none" stroke="currentColor" viewBox="0 0 24 24">
            <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2"
        ...
        <NuxtLink to="/ai-assistant" class="sidebar-nav-item" :class="{ active: route.path === '/ai-assistant' }" @click="sidebarOpen = false">
          <svg class="sidebar-nav-icon" fill="none" stroke="currentColor" viewBox="0 0 24 24">
            <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2"
      ...
      <header class="topbar">
        <div style="display: flex; align-items: center; gap: 12px;">
          ...
          <div class="topbar-breadcrumb">
            <span class="hidden-mobile">CliniqAI</span>
            <span class="topbar-breadcrumb-sep hidden-mobile">/</span>
        ...
        <div class="topbar-actions">
          <NuxtLink to="/patients/new" class="btn btn-primary btn-sm">
            ...
            <span class="hidden-mobile">Novo Paciente</span>
          </NuxtLink>
        </div>
      </header>
